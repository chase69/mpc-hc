...
FOR %%G IN (
 "Arabic" "Armenian" "Basque" "Belarusian" "Bengali" "Bulgarian" "Catalan"
 ...
 "Hebrew" "Hungarian" "Indonesian" "Italian" "Japanese" "Khmer" "Korean" "Malay"
 "Polish" "Portuguese (Brazil)" "Romanian" "Russian" "Serbian" "Slovak" "Slovenian"
