...
lt.WinVersionTooLowError=[name] veikimui reikalingas Windows XP su 3-čiu pakeitimų paketu arba naujesnė versija.
...
lt.msg_SetupIsRunningWarning=MPC-HC diegimas jau vyksta!
#if defined(sse_required)
lt.msg_simd_sse=Šiai MPC-HC versijai reikalingas centrinis procesorius CPU su SSE plėtinio palaikymu.%n%nJūsų procesorius neturi šių galimybių.
#elif defined(sse2_required)
lt.msg_simd_sse2=Šiai MPC-HC versijai reikalingas centrinis procesorius CPU su SSE2 plėtinio palaikymu.%n%nJūsų procesorius neturi šių galimybių.
#endif
